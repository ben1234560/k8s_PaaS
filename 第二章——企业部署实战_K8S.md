...
> - **-qa：**查看已安装的所有软件包
>
> **rpm和yum安装的区别：**前者不坚持相依性问题，后者检查（即相关依赖包）
>
> **named.conf文件内容解析：**
>
...
> **WHAT：**  证书，可以用来审计也可以爆炸安全，k8S组件启动的时候，则需要有对应的证书，证书的详解你也可以在网上搜到，这里就不细细说明了
>
...
### 安装部署controller-managerv（节点控制器/调度器服务）
